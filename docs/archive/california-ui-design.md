...
<div className="county-card">
  ...
  <div className="card-content">
    ...
    <div className="difficulty-indicator">
      ...
      <div className="difficulty-stars">{/* Star rating display */}</div>
    </div>
  </div>
...
<div className="achievement-badge">
  ...
  <div className="badge-content">
    ...
    <div className="badge-rarity">
      ...
      <div className="rarity-stars">{/* Star rating for rarity */}</div>
    </div>
  </div>
...
/* Loading Animations */
.loading-skeleton {
  background: linear-gradient(90deg, var(--ca-fog) 25%, var(--ca-sky) 50%, var(--ca-fog) 75%);
...
const CountyImage = ({ src, alt, ...props }) => {
  ...
  return (
    <div ref={imgRef} className="county-image-container">
      ...
      {!isLoaded && isInView && <div className="loading-skeleton county-image-skeleton" />}
    </div>
  );
};
```
