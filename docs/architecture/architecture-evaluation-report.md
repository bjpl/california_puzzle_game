...
(-counties,
  ...
  mistakes,
  streak - timerState,
  gameSettings - placementHistory,
  completedRegions -
    // gameStore ALSO manages:
    score,
  streak,
  mistakes - placedCounties,
  remainingCounties - difficulty,
...
_This report should be updated quarterly or after major architectural changes._
