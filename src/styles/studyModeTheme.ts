...
export const getHeadingStyle = (level: 1 | 2 | 3 | 4) => {
  const styles = {
    1: {
      fontSize: studyModeTheme.fontSize['3xl'],
      color: studyModeTheme.neutral[900],
      fontWeight: 700,
    },
    2: {
      fontSize: studyModeTheme.fontSize['2xl'],
      color: studyModeTheme.neutral[800],
      fontWeight: 600,
    },
    3: {
      fontSize: studyModeTheme.fontSize.xl,
      color: studyModeTheme.neutral[800],
      fontWeight: 600,
    },
    4: {
      fontSize: studyModeTheme.fontSize.lg,
      color: studyModeTheme.neutral[700],
      fontWeight: 500,
    },
  };
  return styles[level];
