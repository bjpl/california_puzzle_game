...
export const countyEducationData: CountyEducation[] = [
  ...
  },
  {
    ...
    specificData: {
      ...
      historicalEvents: [
        ...
        '1969 San Diego State College protests',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    specificData: {
      ...
      historicalEvents: [
        ...
        '1966 Black Panther Party founding',
        '1989 Loma Prieta earthquake',
  ...
  // CENTRAL VALLEY REGION
  {
    ...
    specificData: {
      ...
      climate:
        'Mediterranean climate, average 75°F summer/50°F winter, 18 inches rainfall annually',
      ...
      historicalEvents: [
        ...
        '1854 State capital designated',
        '1860 Pony Express launch',
        '1869 Transcontinental Railroad completion',
        '1963 Capitol restoration',
      ],
    },
  },
  {
    ...
    specificData: {
      ...
      nationalParks: [
        ...
        'Yosemite National Park (partial)',
      ],
      majorAttractions: [
      ...
      climate:
        'Mediterranean climate, average 80°F summer/47°F winter, 11 inches rainfall annually',
      ...
      historicalEvents: [
        ...
        '1900 Raisin industry dominance',
        '1942 Fresno Assembly Center',
        '1965 Delano Grape Strike',
        '1980s Hmong resettlement',
      ],
    },
  },
  ...
  // NORTHERN CALIFORNIA REGION
  {
    ...
    specificData: {
      ...
      nationalParks: [
        'Lassen Volcanic National Park (partial)',
      ...
      climate:
        'Mediterranean/Continental, valley 60°F average, mountains cooler, 35 inches rainfall annually',
      elevation: '400 to 14,179 feet (Mount Shasta)',
      notablePeople: ['Joaquin Miller', 'Gary Snyder (resident)', 'Kathleen Norris'],
      historicalEvents: [
        "1848 Gold discovery at Reading's Bar",
        '1851 Shasta City founding',
        '1872 Modoc War',
        '1888 Railroad arrival',
        '1945 Shasta Dam completion',
        '2018 Carr Fire',
      ],
    },
  },
...
export function getMemoryAid(countyId: string): string {
  return (
    geographicalMemoryAids[countyId] ||
    "Study this county's unique features to create your own memory aid!"
  );
}
