...
export const californiaCounties: CaliforniaCounty[] = [
  {
    ...
    trivia: {
      ...
      medium: [
        'What does "alameda" mean in Spanish?',
        'Which major university is located in this county?',
      ],
      hard: [
        'In what year was Alameda County established?',
        'What is the main cargo handled at the Port of Oakland?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'Which county has the smallest population in California?',
        'What mountains are Alpine County located in?',
      ],
      medium: [
        'What is the county seat of Alpine County?',
        'What famous lake is partially in Alpine County?',
      ],
      hard: [
        'When was Alpine County established?',
        'What natural hot springs are located in Alpine County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of Amador County?',
        'What historical period is Amador County famous for?',
      ],
      medium: ['Who was José María Amador?', 'What type of cavern can be found in Amador County?'],
      hard: [
        'In which year was Amador County established?',
        'What river flows through Amador County?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      hard: [
        'In what year was Butte County established?',
        'What river is the Oroville Dam built on?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What famous story is associated with Calaveras County?',
        'What does "calaveras" mean in Spanish?',
      ],
      medium: [
        'Who wrote "The Celebrated Jumping Frog of Calaveras County"?',
        'What type of giant trees grow here?',
      ],
      hard: [
        'What is the county seat of Calaveras County?',
        'What annual event occurs in Angels Camp?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the main agricultural product of Colusa County?',
        'What river runs through Colusa County?',
      ],
      medium: [
        'What Native American tribe was Colusa County named after?',
        'What percentage of the county is agricultural land?',
      ],
      hard: [
        'When was Colusa County established?',
        'What wildlife refuge is located in the county?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What is the county seat of Contra Costa County?',
        'What type of industrial facilities are common here?',
      ],
      hard: [
        'How many counties can be seen from Mount Diablo on clear days?',
        'What naturalist has a historic site in this county?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What is the county seat of Del Norte County?',
        'What natural disaster sometimes affects this coastal area?',
      ],
      hard: [
        'What major river flows through Del Norte County?',
        'In what year was Del Norte County established?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        ...
        'What famous lake is partially in El Dorado County?',
      ],
      medium: ['What does "El Dorado" mean?', 'What historic mill is located in this county?'],
      hard: [
        "In what year was gold discovered at Sutter's Mill?",
        'What seasonal attraction involves apple orchards?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'How many different crops are grown in Fresno County?',
        'What ethnic population has a large community here?',
      ],
      hard: [
        'What underground attraction was built by one man over 40 years?',
        "What is Fresno County's ranking in US agricultural production?",
      ],
    },
  },
  {
    ...
    population: 28917,
    area: 1315,
    coordinates: { latitude: 39.524, longitude: -122.3094 },
    ...
    trivia: {
      easy: [
        'What is the county seat of Glenn County?',
        'What grain is Glenn County famous for producing?',
      ],
      medium: [
        'Who was Glenn County named after?',
        'What type of refuge is located in the county?',
      ],
      hard: [
        'In what year was Glenn County established?',
        'What makes Glenn County unique among California counties in terms of establishment date?',
      ],
    },
  },
  {
    ...
    population: 135558,
    area: 3568,
    coordinates: { latitude: 40.745, longitude: -123.8695 },
    ...
    trivia: {
      ...
      medium: [
        'Who was Humboldt County named after?',
        'What scenic drive features giant redwoods?',
      ],
      hard: [
        'What university is located in Humboldt County?',
        'What bay provides harbor access to the Pacific?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        "What is unique about Imperial County's elevation?",
        'When was Imperial County established?',
      ],
      medium: [
        'What large inland lake is located in Imperial County?',
        'What type of energy is produced here using underground heat?',
      ],
      hard: [
        'What desert covers most of Imperial County?',
        'What makes Imperial Valley important for agriculture?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the highest point in the continental United States?',
        'What valley contains the lowest point?',
      ],
      medium: [
        'What is unique about the elevation extremes in Inyo County?',
        'What type of ancient trees grow here?',
      ],
      hard: [
        'What Japanese American internment camp was located in Inyo County?',
        'How far apart are Mount Whitney and Death Valley?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        ...
        'What energy resource is Kern County famous for?',
      ],
      medium: [
        'What nuts is Kern County a leading producer of?',
        'What type of renewable energy farm is located here?',
      ],
      hard: [
        'What mountain range contains many wind turbines in Kern County?',
        'What river flows through Kern County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of Kings County?',
        'What river was Kings County named after?',
      ],
      medium: [
        "What historic town was California's only all-black community?",
        'What type of farming is Kings County known for?',
      ],
  ...
  },
  {
    ...
    population: 64148,
    area: 1258,
    coordinates: { latitude: 39.084, longitude: -122.7593 },
    ...
    trivia: {
      ...
      medium: [
        'What makes Clear Lake special among California lakes?',
        'What type of renewable energy is produced here?',
      ],
  ...
  },
  {
    ...
    trivia: {
      ...
      hard: [
        'What trail was converted from a former railroad?',
        'What two mountain ranges meet in Lassen County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        ...
        'What neighborhood is famous for movies and entertainment?',
      ],
      medium: [
        'What theme park opened in Anaheim in 1955?',
        'What observatory is located in Griffith Park?',
      ],
      hard: [
        'What mountain ranges are located in Los Angeles County?',
        'What pier is a famous tourist attraction in Santa Monica?',
      ],
    },
  },
  {
    ...
    population: 158006,
    area: 2138,
    coordinates: { latitude: 37.155, longitude: -119.77 },
    ...
    trivia: {
      easy: [
        'What does "madera" mean in Spanish?',
        'What famous national park partially extends into this county?',
      ],
      medium: [
        'What is the county seat of Madera County?',
        'What type of alcoholic beverage is produced here?',
      ],
      hard: [
        'In what year was Madera County established?',
        'What center displays ancient fossils found in the area?',
      ],
    },
  },
  {
    ...
    naturalFeatures: [
      ...
      'Pacific Ocean coastline',
      'Mount Tamalpais',
      'Golden Gate Bridge (northern end)',
    ],
    culturalLandmarks: [
      'Golden Gate Bridge',
    ...
    trivia: {
      easy: [
        'What famous bridge connects Marin County to San Francisco?',
        'What woods are famous for redwood trees?',
      ],
      medium: ['Who was Chief Marin?', 'What mountain peak is popular with hikers?'],
      hard: [
        'What national seashore is located in western Marin County?',
        'What makes Muir Woods special among California forests?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What does "mariposa" mean in Spanish?',
        'What famous national park is mostly located here?',
      ],
      medium: [
        'What museum displays mining artifacts and minerals?',
        'What river flows through Yosemite in this county?',
      ],
      hard: [
        'Is Mariposa County one of the original 27 counties?',
        'What percentage of Yosemite National Park is in Mariposa County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of Mendocino County?',
        'What type of alcoholic beverage is this county famous for?',
      ],
      medium: [
        'What Victorian coastal village is a major tourist attraction?',
        'What cape was the county named after?',
      ],
      hard: [
        'What valley is particularly famous for wine production?',
        'What lighthouse marks the western coast?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What is the county seat of Merced County?',
        'What type of farming is important here besides crops?',
      ],
  ...
  },
  {
    ...
    trivia: {
      easy: [
        'What Native American tribe was Modoc County named after?',
        'What is the county seat?',
      ],
      medium: [
        'What geographic region is Modoc County part of?',
        'What plateau characterizes the landscape?',
      ],
      hard: [
        'What national monument featuring volcanic formations is nearby?',
        'What year was Modoc County established?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What ancient lake is Mono County famous for?',
        'What winter sport is popular at Mammoth Mountain?',
      ],
      medium: [
        'What historic ghost town is preserved here?',
        'What is the county seat of Mono County?',
      ],
      hard: [
        'How old is Mono Lake approximately?',
        'What mountain range dominates the eastern part of the county?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What valley is known as "America\'s Salad Bowl"?',
        'What famous aquarium is located in Monterey?',
      ],
      medium: [
        "What was Monterey's historical significance in Mexican California?",
        'What scenic coastal area extends south from Monterey?',
      ],
      hard: [
        'What mission was established by Father Junípero Serra?',
        'What prestigious golf course is located at Pebble Beach?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'How many wineries are approximately in Napa County?',
        'What Native American tribe was the county named after?',
      ],
  ...
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'Which was named first: Nevada County or Nevada State?',
        'What major gold mine operated here?',
      ],
      hard: [
        'What architectural style is preserved in Nevada City?',
        'What river is popular for recreation in the county?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What fruit was Orange County originally famous for?',
        'What famous theme park is located here?',
      ],
      medium: ['When did Disneyland open?', 'What is the county seat of Orange County?'],
      hard: [
        'What historic mission is famous for swallows returning each spring?',
        'What crystal structure was a famous religious landmark?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What type of mining was Placer County named after?',
        'What famous lake is partially in this county?',
      ],
  ...
  },
  {
    ...
    trivia: {
      ...
      medium: [
        ...
        'What large lake is located in the county?',
      ],
      hard: [
        'What scenic byway runs through Plumas County?',
        'What recreational area contains many mountain lakes?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What desert resort city is located in Riverside County?',
        'What national park is partially in this county?',
      ],
      medium: [
        'What valley hosts a famous annual music festival?',
        'What historic hotel is located in the city of Riverside?',
      ],
      hard: [
        'What mountain ranges are located in Riverside County?',
        'What inland sea borders the county?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        ...
        'What river is Sacramento County named after?',
      ],
      medium: [
        'What historic district preserves Gold Rush architecture?',
        "What is California's oldest art museum?",
      ],
      hard: [
        'What building houses the California state government?',
        'What river confluence is located in Sacramento?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What major geological fault runs through the county?',
        'What valley was the county named after?',
      ],
      hard: [
        'What state historic park preserves a mission and town?',
        'What year was San Benito County established?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the largest county in the US by area?',
        'What famous highway passes through San Bernardino County?',
      ],
      medium: [
        'What mountain lakes are popular resort destinations?',
        'What ghost town represents the Old West?',
      ],
      hard: [
        'What desert covers much of the county?',
        'What national park extends into San Bernardino County?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        ...
        'What park contains many museums and the zoo?',
      ],
      hard: [
        'What aircraft carrier is now a museum?',
        'What desert extends into eastern San Diego County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        ...
        'What former prison island is now a tourist attraction?',
      ],
      medium: [
        'What street is known as the "crookedest street in the world"?',
        'What type of public transportation is San Francisco famous for?',
      ],
      hard: [
        'What makes San Francisco County unique among California counties?',
        'What wharf area is a major tourist destination?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of San Joaquin County?',
        'What saint was the county named after?',
      ],
      medium: [
        'What makes Stockton unusual as an inland city?',
        'What delta system is located here?',
      ],
      hard: [
        'What channel allows ships to reach Stockton?',
        'What private university is located in Stockton?',
      ],
    },
  },
  {
    ...
    population: 282424,
    area: 3304,
    coordinates: { latitude: 35.305, longitude: -120.6625 },
    ...
    trivia: {
      easy: [
        'What castle was built by newspaper magnate William Randolph Hearst?',
        'What distinctive rock formation is located near Morro Bay?',
      ],
      medium: [
        'What university is known for its engineering programs?',
        'What beach is famous for its sand dunes?',
      ],
      hard: [
        'What mission was founded in the city of San Luis Obispo?',
        'What type of geological formation is Morro Rock?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of San Mateo County?',
        'What coastal town is famous for pumpkins?',
      ],
      medium: [
        'What prestigious university has facilities in San Mateo County?',
        'What gardens are famous for their formal design?',
      ],
      hard: [
        'What state park is known for elephant seal viewing?',
        'What makes San Mateo County part of Silicon Valley?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What university is located in Santa Barbara?',
        'What islands form a national park off the coast?',
      ],
      hard: [
        'What mission is known as the "Queen of the Missions"?',
        'What valley is known for wine production?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What valley is Santa Clara County the heart of?',
        'What is the largest city in Northern California?',
      ],
      medium: [
        'What mysterious house has staircases leading to nowhere?',
        'What major university is located here?',
      ],
      hard: [
        'What theme park is located in Santa Clara County?',
        'What type of companies is Silicon Valley famous for?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What beach attraction is Santa Cruz famous for?',
        'What university has a campus in the redwoods?',
      ],
      medium: [
        'What bay borders Santa Cruz County to the south?',
        'What sport is Santa Cruz known for?',
      ],
      hard: [
        'What scenic area extends into northern Santa Cruz County?',
        'What makes UC Santa Cruz campus unique?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What type of geological formation is Mount Shasta?',
        'What dam creates the largest reservoir in California?',
      ],
      hard: [
        'What unique bridge spans the Sacramento River in Redding?',
        'What mountain range is Shasta County part of?',
      ],
    },
  },
  {
    ...
    population: 3236,
    area: 953,
    coordinates: { latitude: 39.578, longitude: -120.8039 },
    ...
    trivia: {
      ...
      medium: [
        'What historic period does Downieville represent?',
        "What is Sierra County's population ranking?",
      ],
      hard: [
        'What river flows through Sierra County?',
        'What recreational area contains many alpine lakes?',
      ],
    },
  },
  {
    ...
    population: 44076,
    area: 6278,
    coordinates: { latitude: 41.81, longitude: -122.635 },
    ...
    trivia: {
      easy: [
        'What state borders Siskiyou County to the north?',
        'What major volcanic peak is located here?',
      ],
      medium: [
        'What is the county seat of Siskiyou County?',
        'What national monument preserves volcanic landscapes?',
      ],
      hard: [
        'What mountain ranges converge in Siskiyou County?',
        'What river system flows through the county?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      hard: [
        'What bay is formed by the confluence of rivers?',
        'What Native American tribe was Chief Solano associated with?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What historic revolt occurred in Sonoma in 1846?',
        'What river flows through Sonoma County?',
      ],
      hard: [
        'What plaza was the center of the Bear Flag Revolt?',
        'What natural reserve protects ancient redwood trees?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of Stanislaus County?',
        'What type of agricultural products is the county known for?',
      ],
      medium: [
        'What famous winery has its headquarters here?',
        'What slogan appears on the Modesto Arch?',
      ],
      hard: [
        'What mansion is a historic landmark in Modesto?',
        'What two rivers flow through Stanislaus County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'Who was Sutter County named after?',
        "What is known as the world's smallest mountain range?",
      ],
      medium: [
        'What is the county seat of Sutter County?',
        'What crops is Sutter County known for?',
      ],
  ...
  },
  {
    ...
    trivia: {
      easy: [
        'What is the county seat of Tehama County?',
        'What does "tehama" mean in Native American language?',
      ],
      medium: [
        'What historic role did Red Bluff play in transportation?',
        'What nuts is Tehama County known for producing?',
      ],
      hard: [
        'What state historic park preserves an adobe home?',
        'What year was Tehama County established?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What type of temple is preserved in Weaverville?',
        'What lake provides recreation in Trinity County?',
      ],
      hard: [
        'What national forest covers much of Trinity County?',
        'What state historic park preserves Chinese heritage?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        "What national park contains the world's largest tree?",
        'What is the county seat of Tulare County?',
      ],
      medium: [
        "What is the name of the world's largest tree by volume?",
        'What lake was Tulare County named after?',
      ],
      hard: [
        'What cave system can be toured in Sequoia National Park?',
  ...
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What historic town preserves Gold Rush era buildings?',
        'What type of historic transportation is preserved here?',
      ],
      hard: [
        'What state historic park features steam trains?',
        'What river flows through Tuolumne County?',
      ],
    },
  },
  {
    ...
    trivia: {
      easy: [
        'What fruit is Ventura County famous for growing?',
        'What presidential library is located here?',
      ],
      medium: [
        'What mission was founded in the city of Ventura?',
        'What islands form a national park off the coast?',
      ],
      hard: [
        'What plain is known for its fertile agricultural land?',
        'What mountain range extends into Ventura County?',
      ],
    },
  },
  {
    ...
    culturalLandmarks: [
      ...
      'California State Fair (sometimes)',
    ...
    trivia: {
      ...
      medium: [
        'What is UC Davis particularly known for studying?',
        'What does "yolo" possibly mean in Native American language?',
      ],
      hard: [
        'What historic opera house is located in Woodland?',
        'What creek flows through Yolo County?',
      ],
    },
  },
  {
    ...
    trivia: {
      ...
      medium: [
        'What Air Force base is located in Yuba County?',
        "What was Marysville's nickname during the Gold Rush?",
      ],
      hard: [
        'What Chinese temple is preserved in Marysville?',
        'What mountain formation is shared with neighboring Sutter County?',
      ],
    },
  },
];
...
export const difficultyLevels = {
  easy: californiaCounties
    .filter((county) => county.difficulty === 'easy')
    .map((county) => county.id),
  medium: californiaCounties
    .filter((county) => county.difficulty === 'medium')
    .map((county) => county.id),
  hard: californiaCounties
    .filter((county) => county.difficulty === 'hard')
    .map((county) => county.id),
};
...
export const getCountiesByDifficulty = (
  difficulty: 'easy' | 'medium' | 'hard'
): CaliforniaCounty[] => {
  return californiaCounties.filter((county) => county.difficulty === difficulty);
};

export const getTriviaByDifficulty = (
  countyId: string,
  difficulty: 'easy' | 'medium' | 'hard'
): string[] => {
