...
export const memoryAidsData: MemoryAid[] = [
  ...
  },
  {
    ...
    visualCues: ['West of Napa', 'Touches Pacific Ocean', 'Larger than Napa', 'North of Marin'],
    associations: [
...
export function getCountiesByPattern(
  pattern: keyof typeof memoryPatterns,
  subPattern?: string
): string[] {
  if (subPattern) {
    return (memoryPatterns[pattern] as Record<string, string[]>)[subPattern] || [];
  }
