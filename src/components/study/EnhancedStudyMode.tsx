...
import { getCountyEducation, getRelatedCounties } from '../../data/countyEducation';
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-4">
                        {selectedCounty.naturalFeatures && (
                          <div className="p-4 bg-teal-50 rounded-lg">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {selectedCounty.naturalFeatures.map(
                        ...
                        {selectedCounty.culturalLandmarks && (
                          <div className="p-4 bg-pink-50 rounded-lg">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {selectedCounty.culturalLandmarks.map(
                                (landmark: string, idx: number) => (
                                  <span
                                    key={idx}
                        ...
                        {(() => {
                          ...
                          if (relatedIds.length === 0) {
                            relatedIds = counties
                              .filter(
                                (c) =>
                                  c.region === selectedCounty.region && c.id !== selectedCounty.id
                              )
                              .slice(0, 6)
                              .map((c) => c.id);
                          }
