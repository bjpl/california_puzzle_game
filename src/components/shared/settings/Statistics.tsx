      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-blue-50 p-4 rounded-lg text-center">
          <div className="text-2xl font-bold text-blue-600">
            {progressData?.totalGamesPlayed || 0}
          </div>
          ...
          <div className="space-y-2">
            {recentUnlocks.map((achievement) => (
              ...
              >
                ...
                <div
                  className={`px-2 py-1 rounded text-xs font-medium ${getRarityBg(achievement.rarity)} ${getRarityColor(achievement.rarity)}`}
                >
                  {achievement.rarity}
                </div>
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {Object.entries(rarityStats).map(([rarity, stats]) => (
          <div
            key={rarity}
            className={`p-4 rounded-lg ${getRarityBg(rarity as AchievementRarity)}`}
          >
        ...
        <div className="grid gap-4">
          {achievements
            ...
            .map((achievement) => (
              <div
                key={achievement.id}
                className={`p-4 rounded-lg border ${achievement.isUnlocked ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'}`}
              >
