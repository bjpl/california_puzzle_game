    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      ...
      >
        ...
        <div className="text-center">
          {/* Header */}
          <div className="mb-4">
            <div className="text-sm font-medium opacity-90 mb-1">🏆 ACHIEVEMENT UNLOCKED!</div>
            <div
              className={`inline-block px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide border ${styles.border} bg-white/20`}
            >
              {achievement.rarity}
            </div>
          </div>
          ...
          {/* Achievement Info */}
          <div className="mb-4">
            <div className="text-4xl mb-2 animate-bounce">{achievement.icon}</div>
